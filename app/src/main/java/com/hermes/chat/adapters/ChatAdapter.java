...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.setData(dataList.get(position), holder);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final Chat chat, MyViewHolder holder) {
...
//            Glide.with(context).load(chatUser != null ? chatUser.getImage() : chatGroup.getImage()).apply(new RequestOptions().placeholder(R.drawable.ic_placeholder)).into(image);
            ...
            if (chatUser != null && chatUser.getImage() != null && !chatUser.getImage().equalsIgnoreCase("")) {
                if (chatUser.getBlockedUsersIds() != null && !chatUser.getBlockedUsersIds().contains(userId))
                    Picasso.get()
                            ...
                            .resizeDimen(com.intuit.sdp.R.dimen._40sdp, com.intuit.sdp.R.dimen._40sdp)
                            .centerInside()
                            .into(image);
                else
                    Picasso.get()
            ...
            if (chat.isSelected())
                background.setBackgroundResource(R.drawable.message_selected_item_border);
            else
                background.setBackgroundResource(R.drawable.message_item_border);
                ...
                if (message != null && message.size() > 0) {
                    ...
                    if (chatUser != null) {
                        ...
                        if (from.equalsIgnoreCase("group")
                                ...
                                && !chatGroup.getGrpExitUserIds().contains(userId)) {
                            for (int i = 0; i < message.size(); i++) {
                                if (!message.get(i).getSenderId().equalsIgnoreCase(userId)
                                        && !message.get(i).getReadUserIds().contains(userId)
                                        && message.get(i).getUserIds().contains(userId))
                                    count++;
                            }
    ...
    private void loadImages(Group chatGroup, MyViewHolder holder) {
        ...
        if (userIds.size() > 4) {
            holder.groupImg1.setVisibility(View.VISIBLE);
            holder.groupImg2.setVisibility(View.VISIBLE);
            holder.groupImg3.setVisibility(View.VISIBLE);
            holder.groupImg4.setVisibility(View.VISIBLE);
            ...
            holder.groupImg2.setVisibility(View.VISIBLE);
            holder.groupImg3.setVisibility(View.VISIBLE);
            holder.groupImg4.setVisibility(View.GONE);
            groupImgCount.setVisibility(View.GONE);
            ...
            holder.groupImg1.setVisibility(View.VISIBLE);
            holder.groupImg2.setVisibility(View.VISIBLE);
            holder.groupImg3.setVisibility(View.GONE);
            holder.groupImg4.setVisibility(View.GONE);
            groupImgCount.setVisibility(View.GONE);
            ...
            holder.groupImg1.setVisibility(View.VISIBLE);
            holder.groupImg2.setVisibility(View.GONE);
            holder.groupImg3.setVisibility(View.GONE);
            holder.groupImg4.setVisibility(View.GONE);
            groupImgCount.setVisibility(View.GONE);
