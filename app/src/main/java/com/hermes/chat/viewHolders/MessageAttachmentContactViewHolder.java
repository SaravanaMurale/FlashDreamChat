...
import com.hermes.chat.adapters.ContactsAdapter;
...
import com.hermes.chat.utils.MyFileProvider;
...
public class MessageAttachmentContactViewHolder extends BaseMessageViewHolder {
    ...
    public MessageAttachmentContactViewHolder(View itemView, int attachmentType,
                                              OnMessageItemClick itemClickListener) {
    ...
    public void setData(Message message, int position, HashMap<String, User> myUsers,
        ...
        try {
            ...
            if (message.getId() != null) {
                ...
                text.setText((vcard != null && vcard.getFormattedName() != null) ? vcard.
                        getFormattedName().getValue() : "Contact");
