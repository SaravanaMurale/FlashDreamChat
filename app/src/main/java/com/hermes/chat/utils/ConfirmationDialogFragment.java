...
public class ConfirmationDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.yes)).setText(getCommonPage(getActivity()).getLblYes());
        ((TextView) view.findViewById(R.id.no)).setText(getCommonPage(getActivity()).getLblNo());
